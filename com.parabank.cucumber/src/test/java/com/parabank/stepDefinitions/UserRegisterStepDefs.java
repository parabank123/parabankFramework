...
//	}
	...
	public void click_on_open_new_saving_account_link() throws InterruptedException {
		 ...
		 Thread.sleep(2000);
		 WebElement we= userPage.newAccountId;
		 savingAccountNumber =we.getText();
	}
...
//	}
	...
	System.out.println("param="+this.checkingAccountNumber);
		accounts.selectByValue(this.checkingAccountNumber);
		Thread.sleep(1000);
